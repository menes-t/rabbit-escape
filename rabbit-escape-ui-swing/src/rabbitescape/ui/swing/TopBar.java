...
public class TopBar implements Physics.StatsChangedListener
{
    ...
    private static final String bonusTimer = "BonusTime : ${time}";
    ...
    private final JLabel bonusTime;
        ...
        String worldName )
    {
        ...
        addLabel( worldName, 150 );
        this.bonusTime = addLabel( "" );
    ...
    {
        setCount( bonusTime, bonusTimer, String.valueOf( time ) );
    }
    ...
    {
        setText( label, text, newMap( "num1", String.valueOf( num1 ), "num2",
            String.valueOf( num2 ) ) );
    }
        ...
        int numLeft )
    {
        setText(
            label,
            text,
            newMap( "ability", ability, "numLeft",
                String.valueOf( numLeft ) ) );
    }
